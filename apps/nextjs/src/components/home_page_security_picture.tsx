...
function SvgComponent(props: React.SVGProps<SVGSVGElement>) {
    return (
        ...
        >
            <path
                d="M747.902 525.36c7.183 12.697 1.092 55.585 1.092 55.585s-39.89-16.886-47.073-29.579a26.413 26.413 0 0145.98-26.007z"
                fill="#f1f1f1"
            />
            <path
                d="M749.572 580.89l-.847.178c-8.162-38.778-36.666-65.075-36.953-65.336l.583-.64c.289.262 28.996 26.738 37.217 65.798z"
                fill="#fff"
            />
            <path
                d="M813.173 539.818c-9.748 17.683-64.706 41.638-64.706 41.638s-9.061-59.263.681-76.94a36.556 36.556 0 1164.025 35.302z"
                fill="#f1f1f1"
            />
            <path
                d="M748.952 582.098l-.826-.87c39.77-37.768 50.065-90.444 50.164-90.972l1.178.222c-.1.531-10.458 53.577-50.516 91.62z"
                fill="#fff"
            />
            <path
            ...
            <path
                fill="#fff"
                d="M192.931 261.581L151.235 207.969 175.483 189.11 195.226 214.494 261.921 144.088 284.224 165.219 192.931 261.581z"
            />
            <path
                d="M818.07 584h-381a1 1 0 010-2h381a1 1 0 010 2z"
                fill="#cacaca"
            />
            <path
                fill="#ffb8b8"
                d="M547.206 568.237L562.671 568.236 570.029 508.583 547.203 508.584 547.206 568.237z"
            />
            <path
            ...
            <path
                fill="#ffb8b8"
                d="M599.206 568.237L614.671 568.236 622.029 508.583 599.203 508.584 599.206 568.237z"
            />
            <path
                d="M595.26 563.188l30.458-.002h.001a19.411 19.411 0 0119.41 19.41v.63l-49.868.003z"
                fill="#2f2e41"
            />
            <path
                fill="#2f2e41"
                d="M571.514 358.75L575.224 548 545.213 546.139 524.393 425.597 517.817 343.408 571.514 358.75z"
            />
            <path
            ...
            <path
                fill="#ccc"
                d="M584.936 137.738L589.047 143.966 600.006 174.649 591.239 294.095 539.734 295.192 533.16 158.211 546.933 140.995 584.936 137.738z"
            />
            <path
                d="M512.338 161.499l-8.766-1.096s-2.192 1.096-3.288 8.767-14.246 75.613-14.246 75.613l17.534 83.284 19.725-26.3-12.054-46.026 12.054-46.025z"
                fill="#2f2e41"
            />
            <path
                fill="#2f2e41"
                d="M624.114 160.404L630.689 160.404 647.127 249.166 631.785 318.204 616.443 293 620.826 265.604 618.635 241.496 610.964 227.249 624.114 160.404z"
            />
            <path
                d="M578.535 99.594l-4.88-1.22s-3.66-20.739-12.2-18.299-30.497 4.88-30.497-4.88 20.738-18.298 32.938-17.078 27.779 5.267 31.718 23.178c6.313 28.713-13.027 35.966-13.027 35.966l.322-1.046a16.282 16.282 0 00-4.374-16.621zM504.668 160.403l35.067-14.246 8.218-6.027 24.657 109.036 11.506-112.323 45.477 23.56-15.341 74.517-2.192 28.492 6.575 23.013s23.013 16.437 15.342 33.97-16.438 18.63-16.438 18.63-37.258-35.067-39.45-43.834-5.48-24.108-5.48-24.108-18.629 70.134-40.545 69.038-21.917-24.109-21.917-24.109l5.48-24.108 8.766-25.204-4.384-41.642z"
                fill="#2f2e41"
            />
        </svg>
    );
